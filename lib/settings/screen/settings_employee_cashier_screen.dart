...
class SettingsCashierScreen extends StatefulWidget {
  const SettingsCashierScreen({Key? key}) : super(key: key);

  @override
  State<SettingsCashierScreen> createState() => _SettingsCashierScreenState();
}

class _SettingsCashierScreenState extends State<SettingsCashierScreen> {
  @override
  void initState() {
